...
- [UML](https://icarus.cs.weber.edu/~dab/cs1410/textbook/uml.html)
...
- [23 种设计模式 iOS 实现](https://github.com/huang303513/Design-Pattern-For-iOS)

- [C++ 设计模式课件](https://github.com/rhyspang/CPP-Design-Patterns)

- [设计模式](https://github.com/Jueee/design-patterns)

- [码农充电站:design-pattern](https://codeshellme.github.io/dp/)
